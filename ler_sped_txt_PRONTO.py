...
def ler_arq_sped(arq_txt):
    ...
    with open(arq_txt, 'r',encoding='ANSI') as arquivo:  #US-ASCII #utf-16 #ISO-8895-1 #ANSI
        ...
        var = []
        for linha in msg:
            if linha.startswith('|1100|'): #if '|C100|' in linha:
                num += 1
...
with pd.ExcelWriter(r'ARQ\PISCOFINS_20211201_SPED-1100.xlsx', mode='w') as writer:
    #df1.to_excel(writer, sheet_name='Sheet_name_3')
    df_sped.to_excel(writer, sheet_name='1100')
